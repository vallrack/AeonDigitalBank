...
exports.deleteVirtualCard = exports.toggleVirtualCardFreeze = exports.createVirtualCard = exports.adminDeleteUser = exports.adminUpdateUser = exports.adminDeposit = exports.adminCreateUser = exports.processTransfer = exports.searchRecipient = exports.onUserCreated = void 0;
...
// 2. searchRecipient
exports.searchRecipient = functions.https.onCall(async (data, context) => {
    if (!context.auth)
...
exports.adminDeposit = functions.https.onCall(async (data, context) => {
    if (!context.auth)
        throw new functions.https.HttpsError("unauthenticated", "User must be authenticated.");
    const callerSnap = await db.collection("users").doc(context.auth.uid).get();
...
exports.toggleVirtualCardFreeze = functions.https.onCall(async (data, context) => {
    if (!context.auth)
        throw new functions.https.HttpsError("unauthenticated", "User must be authenticated.");
...
exports.deleteVirtualCard = functions.https.onCall(async (data, context) => {
    if (!context.auth)
        throw new functions.https.HttpsError("unauthenticated", "User must be authenticated.");
    const { cardId } = data;
